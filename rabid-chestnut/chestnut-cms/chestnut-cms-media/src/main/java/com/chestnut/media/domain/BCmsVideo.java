...
@Getter
@Setter
@TableName(BCmsVideo.TABLE_NAME)
public class BCmsVideo extends BackupBaseEntity<CmsVideo> {

    @Serial
    private static final long serialVersionUID = 1L;
    
    public static final String TABLE_NAME = DBConstants.BACKUP_TABLE_PREFIX + CmsVideo.TABLE_NAME;
    ...
    @Override
    public CmsVideo toSourceEntity() {
