    ...
    children: [
      {
        ...
        meta: {
          noCache: true,
          title: i18n.t("CMS.ContentCore.Route.EditSite"),
          activeMenu: "/configs/site",
        },
      },
      {
        ...
        meta: {
          noCache: true,
          title: i18n.t("CMS.ContentCore.Route.EditTemplate"),
          activeMenu: "/configs/template",
        },
      },
      {
        path: "file/editor",
        ...
        meta: {
          noCache: true,
          title: i18n.t("CMS.ContentCore.Route.EditFile"),
          activeMenu: "/configs/file",
        },
      },
      {
        path: "content/editor",
        ...
        meta: {
          noCache: true,
          title: i18n.t("CMS.ContentCore.Route.EditContent"),
          activeMenu: "/configs/content",
        },
      },
      {
        path: "exmodel/fields",
        ...
        meta: {
          noCache: true,
          title: i18n.t("CMS.ExModel.RouteExModelField"),
          activeMenu: "/configs/exmodel",
        },
      },
      {
        ...
        meta: {
          noCache: true,
          title: i18n.t("CMS.ContentCore.Route.EditManualBlock"),
          activeMenu: "/configs/content",
        },
      },
      {
        ...
        meta: {
          noCache: true,
          title: i18n.t("CMS.ContentCore.Route.EditAdvSpace"),
          activeMenu: "/operations/advertisement",
        },
      },
      {
        path: "ad/editor",
        ...
        meta: {
          noCache: true,
          title: i18n.t("CMS.ContentCore.Route.EditAdv"),
          activeMenu: "/operations/advertisement",
        },
      },
    ],
    ...
    children: [
      {
        ...
        meta: {
          noCache: true,
          title: i18n.t("CMS.FriendLink.RouteLinkList"),
          activeMenu: "/operations/link",
        },
      },
      {
        ...
        meta: {
          noCache: true,
          title: i18n.t("CMS.CustomForm.RouteFieldList"),
          activeMenu: "/operations/customform",
        },
      },
      {
        ...
        meta: {
          noCache: true,
          title: i18n.t("CMS.CustomForm.RouteData"),
          activeMenu: "/operations/customform",
        },
      },
    ],
    ...
    children: [
      {
        ...
        name: "AuthUser",
        meta: {
          title: i18n.t("System.Role.UserSetting"),
    ...
    children: [
      {
        ...
        name: "Data",
        meta: {
          title: i18n.t("System.Dict.DataList"),
    ...
    children: [
      {
        ...
        name: "GenEdit",
        meta: {
          title: i18n.t("System.GenCode.EditGenConfig"),
          activeMenu: "/tool/gen",
        },
      },
    ],
