export default {
  ...
  System: {
    ...
    Menu: {
      ...
      PermsTips:
        '控制器中定义的权限字符，如：@Priv(type = "sys_user", value = "system:role:add")',
      RouterParams: "路由参数",
  ...
  Monitor: {
    Job: {
      ...
      ClassExample:
        "Class类调用示例：com.test.quartz.task.RyTask.ryParams('ry')",
  ...
  CMS: {
    ...
    Site: {
      ...
      IndexTemplate: "首页模板",
      NoPublishPipeTip:
        "预览/发布需要先添加发布通道（添加前请确认右上角当前站点是否是需要添加发布通道的站点）",
    ...
    Content: {
      ...
      SortDialogTip:
        "内容将会排在下方列表选中的内容之前，选中内容置顶则排序内容也会添加置顶状态，反之则会取消置顶状态。",
  ...
  Mailbox: {
    ...
    Unreviewed: "未阅",
    Detail: "邮箱详情",
    ConfirmReviewed: "确认标记为已阅?",
    ConfirmUnreviewed: "确认标记为未阅?",
  },
};
