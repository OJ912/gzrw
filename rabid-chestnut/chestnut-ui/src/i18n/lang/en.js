export default {
  ...
  Common: {
    ...
    SessionExpired:
      "Session has expired, stay on the current page or re-login.",
    Tips: "Tips",
    SystemTip: "System Tip",
    Relogin: "Re-login",
    InvalidSession: "Invalid session or expired, please re-login.",
    RepeatSubmit:
      "The request is being processed,  please do not submit repeatedly.",
  ...
  Error: {
    ...
    NoPermissionTip:
      "Sorry, you do not have access rights. Please do not engage in illegal operations! You can return to the main page.",
    GoHome: "Back Home",
    Err404: "404 Error!",
    Err404Tip:
  ...
  AccountCenter: {
    ...
    NewPwdRuleUPPER_LOW_LETTER_NUMBERTip:
      "Must contain uppercase and lowercase letters and numbers.",
    NewPwdRuleLETTER_NUMBER_SPECIALTip:
      "Must contain letters, numbers, special characters.",
    NewPwdRuleUPPER_LOW_LETTER_NUMBER_SPECIALTip:
  ...
  System: {
    ...
    Role: {
      ...
      RoleKey: "Role Key",
      RoleKeyTips:
        "Role key cannot be empty and only number, character and underline.",
      Sort: "Sort",
      Status: "Status",
    ...
    Menu: {
      ...
      Status: "Status",
      StatusTips:
        "Router will be invisible and inaccessible when router is disabled.",
      Sort: "Sort",
      Perms: "Permission Key",
      Component: "Component",
      ComponentTips:
        "Component path, eg: `system/user/index`, default directory is `views`.",
      ...
      IsExternalLinkTips:
        "Router must start whith `http(s):// for external link.",
      RouterLink: "Router",
      RouterLinkTips:
        "Router visit path, eg: `user`, Router must start whith `http(s):// for external link. ",
      PermsTips:
        'Permission Key is used for controller, eg: @Priv(type = "sys_user", value = "system:role:add")',
      RouterParams: "Router Params",
      RouterParamsTips:
        'Router default parameters, eg: `{"id": 1, "name": "ry"}`',
      IsCache: "Is Cache",
      IsCacheTips:
        "Cached with `keep-alive`, need component's name same with path.",
      EnableCache: "Cache",
      DisableCache: "Non Cache",
      Visible: "Is Visible",
      VisibleTips:
        "Router is not show in sidebar but accessible when invisible.",
    ...
    Security: {
      ...
      PasswordExpireSecondsTip:
        "0 means never expires, with a maximum of 100 days.",
      ForceModifyPwdAfterAdd: "Modify Pwd For First Login",
      ForceModifyPwdAfterAddTip:
        "Only applicable to adding users in the backend.",
      ...
      ForceModifyPwd:
        "Password needs to be changed after first login or password reset!",
      PwdExpired:
        "Your password has expired. For the security of your account, please change the password immediately!",
    },
    WeChat: {
      Backend: "Backend",
  ...
  Monitor: {
    Job: {
      ...
      ClassExample:
        "Class invoke eg: com.test.quartz.task.RyTask.ryParams('ry')",
    ...
    ScheduledTask: {
      ...
      FixedRateTipY:
        "Yes: The specified time interval between two task start times.",
      FixedRateTipN:
        "No: Specify the duration between the end time of the previous task and the start time of the next task.",
  ...
  CMS: {
    ...
    Site: {
      ...
      NoPublishPipeTip:
        "Preivew or publish need add publish pipe first, confirm the current site before add.",
      ...
      Extend: {
        ...
        WatermarkRatioTip:
          "The ratio of the watermark and watermark should be at least 20 width/height.",
    ...
    Catalog: {
      ...
      BatchAddTip:
        "Each line has one catalog, and two spaces are used in sequence to represent subordinate catalog.",
      ...
      DeleteTip:
        "Are you sure to delete the catalog with contents and chilren?",
      ...
      MappingContentTip:
        "Mapping: only basic content, the extend content is from source.",
      SortUp: "MoveUp",
      SortDown: "MoveDown",
      ...
      Extend: {
        ...
        CatalogPageSize: "Page list Size",
        CatalogPageSizeTip:
          "When the value is -1, the set value of the site is taken",
        EnableIndex: "Enable Content Index",
    ...
    Content: {
      ...
      SortDialogTip:
        "The content will be sort before the selected content in this list. If the selected content is at the top, the sorting content will also be added to the top status, and if not, the top status will be cancelled.",
      CloseContentEditorTip:
        "Closing the page will lose unsaved content. Are you sure to close?",
      ExtendConfig: "Extend",
  ...
  Member: {
    ...
    RuleTips: {
      UserName:
        "Must starts with letter and only letters, numbers and underline can be useds.",
  ...
  MetaModel: {
    ...
    Placeholder: {
      FieldQuery: "Input field name/code",
      FieldOptionsInput:
        "Each line has one option, separated by '=', eg: xx=option 1",
  ...
  Mailbox: {
    ...
    ConfirmReviewed: "Confirm mark as reviewed?",
    ConfirmUnreviewed: "Confirm mark as unreviewed?",
  },
};
